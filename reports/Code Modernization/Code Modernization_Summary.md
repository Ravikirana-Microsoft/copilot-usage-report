...
|----------|-------|------------|---------|
| **AI-Assisted** | 661 | 3.38% | 2 |
| **Human-Written** | 18873 | 96.62% | 48 |
| **Total** | 19534 | 100% | 50 |
...
|--------|---------|------------|----------|------|----|----|----|----|-----|--------------|
| **dev** | 50 | 2 | 661 | 3.38% | 0 | 0 | 0 | 1 | 1 | 13 |
...
This application is **primarily human-written** with only 3.38% AI-assisted code.
