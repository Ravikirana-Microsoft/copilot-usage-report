...
|----------|-------|------------|---------|
| **AI-Assisted** | 165 | 3.48% | 1 |
| **Human-Written** | 4571 | 96.52% | 49 |
| **Total** | 4736 | 100% | 50 |
...
|--------|---------|------------|----------|------|----|----|----|----|-----|--------------|
| **dev** | 50 | 1 | 165 | 3.48% | 0 | 0 | 0 | 1 | 0 | 10 |
...
This application is **primarily human-written** with only 3.48% AI-assisted code.
