...
|----------|-------|------------|---------|
| **AI-Assisted** | 1588 | 2.25% | 1 |
| **Human-Written** | 69005 | 97.75% | 97 |
| **Total** | 70593 | 100% | 98 |
...
|--------|---------|------------|----------|------|----|----|----|----|-----|--------------|
| **dev** | 98 | 1 | 1588 | 2.25% | 0 | 0 | 0 | 0 | 1 | 8 |
...
This application is **primarily human-written** with only 2.25% AI-assisted code.
