...
|----------|-------|------------|---------|
| **AI-Assisted** | 1588 | 2.24% | 1 |
| **Human-Written** | 69202 | 97.76% | 99 |
| **Total** | 70790 | 100% | 100 |
...
|--------|---------|------------|----------|------|----|----|----|----|-----|--------------|
| **dev** | 100 | 1 | 1588 | 2.24% | 0 | 0 | 0 | 0 | 1 | 8 |
...
This application is **primarily human-written** with only 2.24% AI-assisted code.
