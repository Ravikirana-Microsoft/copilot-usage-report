...
> 
> **Last Updated:** 2026-04-22 11:56:57
...
|-------------|------------|---------------|------------|---------------|-------------|----------|----------|
| **BYOC** | **6.75%** | 47 | 6 | 41 | 66191 | 4470 | dev |
| **BYOCC** | **0%** | 0 | 0 | 0 | 0 | 0 | dev |
| **Code Modernization** | **0.56%** | 28 | 1 | 27 | 4297 | 24 | dev |
| **Container Migration** | **0%** | 0 | 0 | 0 | 0 | 0 | dev |
| **Content Generation** | **83.01%** | 38 | 1 | 37 | 55205 | 45828 | dev |
| **Content Processing** | **0%** | 18 | 0 | 18 | 17816 | 0 | dev |
| **CWYD** | **0.73%** | 8 | 1 | 7 | 43180 | 316 | dev |
| **Deploy your AI application** | **0%** | 2 | 0 | 2 | 182 | 0 | main |
| **DKM** | **58.85%** | 28 | 7 | 21 | 33459 | 19691 | dev |
| **Fabric SQL** | **0%** | 0 | 0 | 0 | 0 | 0 | dev |
| **KM Generic** | **17.88%** | 54 | 5 | 49 | 10893 | 1948 | dev |
| **MAAG** | **0%** | 6 | 0 | 6 | 521 | 0 | dev |
| **MACAE v4** | **31.1%** | 213 | 47 | 166 | 92199 | 28676 | main |

### Overall AI Usage: **31.16%**
...
**Latest Reports (2026-04-22 11:56):**

- [MACAE v4 - main](MACAE v4/main/) - AI: 31.1%
- [Content Generation - dev](Content Generation/dev/) - AI: 83.01%
- [KM Generic - dev](KM Generic/dev/) - AI: 17.88%
- [BYOC - dev](BYOC/dev/) - AI: 6.75%
- [CWYD - dev](CWYD/dev/) - AI: 0.73%
- [DKM - dev](DKM/dev/) - AI: 58.85%
- [Code Modernization - dev](Code Modernization/dev/) - AI: 0.56%
...
- [Branch-Level Summary CSV](Branch-Level-Summary_2026-04-22_11-56-57.csv)
- [Consolidated Analysis JSON](Consolidated-Analysis_2026-04-22_11-56-57.json)
