...
|----------|-------|------------|---------|
| **AI-Assisted** | 179 | 5.12% | 3 |
| **Human-Written** | 3315 | 94.88% | 50 |
| **Total** | 3494 | 100% | 53 |
...
| **Human** | <60% | No AI detected | 50 | 94.3% |
...
|--------|---------|------------|----------|------|----|----|----|----|-----|--------------|
| **dev** | 53 | 3 | 179 | 5.12% | 0 | 2 | 0 | 0 | 1 | 13 |
...
This application is **primarily human-written** with only 5.12% AI-assisted code.
