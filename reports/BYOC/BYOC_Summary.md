...
|----------|-------|------------|---------|
| **AI-Assisted** | 2 | 0.18% | 2 |
| **Human-Written** | 1136 | 99.82% | 7 |
| **Total** | 1138 | 100% | 9 |
...
| **Human** | <60% | No AI detected | 7 | 77.8% |
...
This application is **primarily human-written** with only 0.18% AI-assisted code.
