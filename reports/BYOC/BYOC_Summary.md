...
|----------|-------|------------|---------|
| **AI-Assisted** | 2 | 0.17% | 2 |
| **Human-Written** | 1150 | 99.83% | 9 |
| **Total** | 1152 | 100% | 11 |
...
This application is **primarily human-written** with only 0.17% AI-assisted code.
