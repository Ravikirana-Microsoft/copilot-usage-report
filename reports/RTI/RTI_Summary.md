...
|----------|-------|------------|---------|
| **AI-Assisted** | 4 | 2.48% | 2 |
| **Human-Written** | 157 | 97.52% | 11 |
| **Total** | 161 | 100% | 13 |
...
|--------|---------|------------|----------|------|----|----|----|----|-----|--------------|
| **main** | 13 | 2 | 4 | 2.48% | 2 | 0 | 0 | 0 | 0 | 9 |

---

## Branch Reports

- **main**: [main/](main/) - AI: 2.48%
...
This application is **primarily human-written** with only 2.48% AI-assisted code.
