...
|----------|-------|------------|---------|
| **AI-Assisted** | 1627 | 2.89% | 3 |
| **Human-Written** | 54639 | 97.11% | 49 |
| **Total** | 56266 | 100% | 52 |
...
| **Tier 5** | 60-69% | Low confidence | 2 | 66.7% |
...
|--------|---------|------------|----------|------|----|----|----|----|-----|--------------|
| **dev** | 52 | 3 | 1627 | 2.89% | 0 | 1 | 0 | 0 | 2 | 10 |
...
This application is **primarily human-written** with only 2.89% AI-assisted code.
