...
|----------|-------|------------|---------|
| **AI-Assisted** | 8345 | 13.22% | 4 |
| **Human-Written** | 54789 | 86.78% | 127 |
| **Total** | 63134 | 100% | 131 |
...
| **Human** | <60% | No AI detected | 127 | 96.9% |
...
This application is **primarily human-written** with only 13.22% AI-assisted code.
